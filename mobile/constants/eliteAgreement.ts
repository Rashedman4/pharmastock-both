...
// Kept as a standalone bundled content module (not routed through i18next)
// because it's structured legal content, not flat UI strings — same pattern
// as MobileTermsOfService.tsx on the web app. Mirrored in
// pharma-stock/src/content/eliteAgreement.ts — keep both in sync by hand,
// and bump ELITE_AGREEMENT_VERSION whenever the text changes.
...
export const ELITE_AGREEMENT: Record<'en' | 'ar', AgreementContent> = {
  en: {
    ...
    preamble:
      'Bio Pharma Stock ("the Company") has extensive experience analyzing U.S. equities, particularly biopharmaceutical stocks, and issues investment recommendations based on rigorous technical and fundamental analysis. By submitting an Elite Program application, you ("the Member") agree to the following terms governing the Company\'s provision of portfolio recommendations and the profit-sharing arrangement described below.',
    sections: [
      {
    ...
    summary:
      'By applying to the Elite Program, you agree that Bio Pharma Stock will provide investment recommendations for your U.S. stock portfolio in exchange for 15% of net realized profit per winning trade (after offsetting any prior unrecovered losses). This is not investment advice — all investment decisions and any resulting gains or losses remain your sole responsibility.',
